...
const emptyDb = () => ({
  version: 1, owner: null, identities: [], animals: [], inventory: [], notes: [], sensors: [],
...
<main id="app" class="hidden"><nav><button onclick="show('dash')">Dashboard</button><button onclick="show('animals')">Animals</button><button onclick="show('inventory')">Inventory</button><button onclick="show('notes')">Notes</button><button onclick="show('sensors')">Sensors</button><button onclick="show('identities')">Planet IDs</button></nav>
